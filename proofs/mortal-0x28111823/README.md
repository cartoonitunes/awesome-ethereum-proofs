...
Bytecode verification proof for a standalone Mortal contract — the classic self-destruct pattern from the earliest Solidity tutorials.

## Contract

| Field | Value |
|-------|-------|
| Address | `0x28111823d089491106a18a3b1e08f15938f0510b` |
| Deployed | Aug 10, 2015 (block 64,076) |
