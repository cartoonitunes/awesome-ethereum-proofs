...
async function main() {
  ...
  console.log('Contract: 0x28111823d089491106a18a3b1e08f15938f0510b');
  ...
  const txHash = '0xdd43d9ba1d192564f8f68978282fa6d53e95efae7b829a0584b407c2398311dd';
  ...
  if (onChainInput === EXPECTED_CREATION) {
    ...
    if (onChainInput.length !== EXPECTED_CREATION.length) {
      console.log(`Note: on-chain creation is ${onChainInput.length / 2} bytes vs expected ${EXPECTED_CREATION.length / 2} bytes`);
    }
  } else {
    console.log();
