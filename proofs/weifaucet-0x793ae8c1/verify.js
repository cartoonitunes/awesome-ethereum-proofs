...
const SOURCE = fs.readFileSync(path.join(__dirname, 'WeiFaucet.sol'), 'utf8');

const EXPECTED_CREATION = '60606040525b662386f26fc100006000600050819055506116806002600050819055505b610147806100326000396000f300' + TARGET_RUNTIME;
...
async function main() {
  console.log('WeiFaucet Contract Verification');
  console.log('Contract: 0x793ae8c1b1a160bfc07bfb0d04f85eab1a71f4f2');
  ...
  const contract = out.contracts['WeiFaucet'];
  ...
  const txHash = '0x258a93bf65790447d671ba836ca522fecd0f8034bfdad0f95634c0f923a20984';
