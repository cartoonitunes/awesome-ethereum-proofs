...
const SOURCE = fs.readFileSync(path.join(__dirname, 'CoinStub.sol'), 'utf8');

const EXPECTED_CREATION = '60606040525b5b60b58060136000396000f300' + TARGET_RUNTIME;
...
async function main() {
  console.log('CoinStub Contract Verification');
  console.log('Contract: 0x4fb5acbe16ffdda225cb14c64aa84c7e253b08ae');
  ...
  const txHash = '0x2740e6ca150ccd0d3a564f12776d990d7bb13a0f280aee9b413b31b126d807cc';
