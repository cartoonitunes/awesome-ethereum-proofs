...
const SOURCE = fs.readFileSync(path.join(__dirname, 'AdminCheckV2.sol'), 'utf8');
...
async function main() {
  console.log('AdminCheckV2 Contract Verification');
  console.log('Contract: 0x592621b7737425ed3aee2212cebf0a4504f26259');
