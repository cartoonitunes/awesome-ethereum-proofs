...
const SOURCE = fs.readFileSync(path.join(__dirname, 'Exchange.sol'), 'utf8');

const EXPECTED_CREATION = '60606040525b33600060006101000a81548173ffffffffffffffffffffffffffffffffffffffff021916908302179055505b610352806100406000396000f300' + TARGET_RUNTIME;
...
async function main() {
  console.log('Exchange Contract Verification');
  console.log('Contract: 0x1c523996cb7cb5b0a4a48d8097e45093626b23f0');
  ...
  const contract = out.contracts['Exchange'];
  ...
  const txHash = '0xe233b6812a494b74f20c14f764bc0e34bb686fdd452e809ea5cfb2e8383be421';
