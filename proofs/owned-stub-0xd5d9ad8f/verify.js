#!/usr/bin/env node
// Verify Stub reproduces on-chain bytecode byte-for-byte.
// Usage: npm i solc@0.4.26 && node verify.js
// Downloads soljson-v0.1.5+commit.23865e39 if not present in ./ or /tmp/soljson/.
const fs = require('fs'), https = require('https'), path = require('path');
const VER = 'soljson-v0.1.5+commit.23865e39.js';
const OPT = 1, CNAME = 'Stub', SRC = 'Stub.sol', MODE = 'creation';
