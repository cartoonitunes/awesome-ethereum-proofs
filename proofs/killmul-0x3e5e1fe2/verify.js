...
const SOURCE = fs.readFileSync(path.join(__dirname, 'KillMul.sol'), 'utf8');

const EXPECTED_CREATION = '606060405260a48060116000396000f300' + TARGET_RUNTIME;
...
async function main() {
  console.log('KillMul Contract Verification');
  console.log('Contract: 0x3e5e1fe257a6a28dd2001ba84561bfbf9c7c78cd');
  ...
  const txHash = '0xdb63cc54cd5ac231dd31b8866c699dd8a659a78206d9fe775efea9586155e853';
