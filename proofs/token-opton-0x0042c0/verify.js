#!/usr/bin/env node
// Reproducible verification for 0x0042c05dA475FB35e57A31296B08ebF84c1D8DD0
// Downloads soljson-v0.2.0+commit.4dc2445e, compiles token.sol (optimizer ON), checks bytecode byte-for-byte.
...
(async()=>{
  ...
  let raw;
  if(typeof m._compileJSONMulti==='function'){raw=m.cwrap('compileJSONMulti','string',['string','number'])(JSON.stringify({sources:{'token.sol':src}}),1);}
