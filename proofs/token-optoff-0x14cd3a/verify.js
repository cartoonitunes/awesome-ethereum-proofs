#!/usr/bin/env node
// Reproducible verification for 0x14Cd3aA183eed2640fbaC18F8a9f7adFEd6dd181
// Downloads soljson-v0.1.5+commit.23865e39, compiles token.sol (optimizer OFF), checks bytecode byte-for-byte.
...
(async()=>{
  ...
  let raw;
  if(typeof m._compileJSONMulti==='function'){raw=m.cwrap('compileJSONMulti','string',['string','number'])(JSON.stringify({sources:{'token.sol':src}}),0);}
